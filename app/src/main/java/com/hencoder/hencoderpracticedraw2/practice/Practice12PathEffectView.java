...
public class Practice12PathEffectView extends View {
    ...
    Path path = new Path();
    private PathEffect cornerPathEffect, discretePathEffect, dashPathEffect, pathDashPathEffect, sumPathEffect, composePathEffect;
...

    {
        ...
        discretePathEffect = new DiscretePathEffect(20, 10);
